...
def show(board):
    #Displays the board with numbers 0 - 8 to mark available slots
    for row in range(3):
...
def winner(board):
    ...
    #Returns X if there are three Xs in a row
...
def play():
    ...
    turn = "X"
    #Loops while there are available slots in the board
    ...
    #Ends if all slots have been filled but no one got three in alignment
    clear_screen()
    print("Tic-Tac-Toe\n")
    show(board)
    print("\nIt's a draw!")
